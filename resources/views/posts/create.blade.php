    ...
    <div class="flex justify-center items-start min-h-screen bg-white pt-10">
        ...
        <div class="container mx-auto px-4 lg:px-20">
            <div class="w-full p-8 rounded-2xl shadow-2xl">
                <div class="flex">
                    <h1 class="font-bold uppercase text-5xl">Create Your <br /> Post !</h1>
                </div>
                ...
                <div class="my-4">
                    <textarea placeholder="Paragraph*"
                              name="body"
                              id="body"
                              class="w-full h-56 bg-gray-100 text-gray-900 p-3 rounded-lg focus:outline-none focus:shadow-outline">{{old("body")?old("body"):""}}</textarea>
