<x-layout>
 ...
 {{old("body")?old("body"):$footer->body}}</textarea>
                ...
                <div>
                    ...
                    <input  id="phone" name="phone" value="{{old("phone")?old("phone"):$footer->phone}}"
                            class="mt-1 block w-1/2 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input  id="address" name="address" value="{{old("address")?old("address"):$footer->address}}"
                            class="mt-1 block w-1/2 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    <x-forms-eror name="address"/>
                </div>
